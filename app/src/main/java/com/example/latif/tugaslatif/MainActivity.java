package com.example.latif.tugaslatif;
...
public class MainActivity extends AppCompatActivity {
    ...
    String no_telp = "088888888888";
    String email = "latiftaufiqurrohman@gmail.com";
    ...
    public void Email(View view) {
        Intent emailIntent = new Intent(Intent.ACTION_SENDTO, Uri.fromParts("mailto","latiftaufiqurrohman@gmail.com", null));
